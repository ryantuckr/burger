...
Be sure to utilize the [MYSQL Heroku Deployment Guide](../../14-node-express-handlebars/Supplemental/MySQLHerokuDeploymentProcess.pdf) in order to deploy your assignment.
